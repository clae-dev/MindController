...
const QUOTES: Record<'low' | 'medium' | 'high', Quote[]> = {
  low: [
    ...
    {
      text: '행복은 결코 많고 큰 데만 있는 것이 아니다. 작은 것에도 고마워하고 만족할 줄 안다면 행복한 사람이다.',
      author: '법정 스님',
    },
    {
    ...
    { text: '어제보다 오늘 한 번 더 웃었다면, 그걸로 충분해요.', author: '오늘의 마음' },
  ],
  medium: [
    ...
    { text: '네가 이루고 싶은 게 있다면, 체력을 먼저 길러라.', author: '드라마 〈미생〉' },
    {
      text: '별을 노래하는 마음으로 모든 죽어가는 것을 사랑해야지.',
      author: '윤동주, 「서시」',
    },
    { text: '응원해. 너의 모든 처음들을.', author: '드라마 〈스물다섯 스물하나〉' },
    {
      text: '모든 것에는 틈이 있다. 빛은 그 틈으로 들어온다.',
      author: '레너드 코헨',
    },
  ],
  high: [
    ...
    {
      text: '아무것도 아니야. 네가 대수롭지 않게 여기면, 아무것도 아니야.',
      author: '드라마 〈나의 아저씨〉',
    },
    {
      text: '어떻게든 버텨라. 버틴다는 것은 완생으로 나아간다는 것이니까.',
      author: '드라마 〈미생〉',
    },
    ...
    {
      text: '내 가치를 남이 정하게 두지 마. 내 인생은 이제 시작이니까.',
      author: '드라마 〈이태원 클라쓰〉',
    },
  ],
};
